...
alasso_simulation <- function(train.data,test.data,beta){
  start.time <- Sys.time()
...
best_simulation <- function(train.data,test.data,beta){
...
elastic_simulation <- function(train.data,test.data,beta){
  start.time <- Sys.time()
  # 
  ...
  enet_model <- train(Y~.,train.data, method = 'glmnet', tuneGrid = expand.grid( alpha = seq(0,1,length = 10),lambda = seq(0.0001,1,length = 5)),
                      trControl = custom)
...
isis_simulation <- function(train.data,test.data,beta){
  start.time <- Sys.time()
...
lasso_simulation <- function(train.data,test.data,beta){
...
mcp_simulation <- function(train.data,test.data,beta){
...
scad_simulation <- function(train.data,test.data,beta){
...
sis_simulation <- function(train.data,test.data,beta){
  start.time <- Sys.time()
...
sivs_simulation <- function(train.data,test.data,beta){
  start.time <- Sys.time()
  
  train.data$Y<- as.factor(train.data$Y)
  sivs_model <- sivs(X.train,factor(Y.train), family = "binomial",  return.fits = T, verbose = "general", progressbar = T,parallel.cores = NULL ) 
...
sparse_simulation <- function(train.data,test.data,beta){
